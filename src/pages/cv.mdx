...
<div className="flex justify-left content-center items-center w-full">
  <img className="hidden md:inline-block rounded-full mr-8" src="https://www.gravatar.com/avatar/febc3d5f662cd665425a91c67e68bedc?s=200" />
  <div>
...
<ul>
  <li className="list-none">
    <span className="italic">Currently Experienced</span>
    <ul>
      <li>C#</li>
  ...
  <li className="list-none">
    <span className="italic">Past Experience</span>
    <ul>
...
<ul>
  <li className="list-none pr-10">Linux</li>
  <li className="list-none pr-10">Docker</li>
  <li className="list-none pr-10">Git
    <ul>
      <li>Gitlab</li>
      <li>Github</li>
    </ul>
  </li>
  <li className="list-none pr-10">CI/CD
    <ul>
      <li>Gitlab CI/CD</li>
      <li>Github Actions</li>
    </ul>
  </li>
  <li className="list-none pr-10">Databases
    <ul>
      <li>PostgreSQL</li>
      <li>MySQL</li>
    </ul>
  </li>
  <li className="list-none pr-10">Caches and Message Queues
    <ul>
      <li>Redis</li>
      <li>RabbitMQ</li>
    </ul>
